...
class SLAM {
 public:
  ...
  void motion_model(float distance, float x_translation_error_stddev, float y_translation_error_stddev,float rotation_error_stddev);
 ...
 //CorrelativeScanMatching
  float obs_weight = 0.65/500;
  float motion_weight = 1.0/3.0;
